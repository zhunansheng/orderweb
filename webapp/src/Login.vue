...
<div id="band" class="div-relative">
  <div class="div-a">
    <div style='margin-left: 10%'>
      ...
      <p style="margin-left: 20%;margin-top: -10%;font-size: 20px">工单上线平台</p>
    </div>
    <br>
    <Card>
      <Tabs value="custom">
      ...
      <Form ref="formInline" :model="formInline" :rules="ruleInline" inline>
        ...
        <Form-item style="width: 100%">
          ...
          <p style="margin-left: 5%;">2018 © Power By xiaozhu 使用chrome获得最佳体验</p>
        </Form-item>
      </Form>
        </TabPane>
      </Tabs>
...
export default {
  ...
  mounted () {
    if (this.$route.query.hasOwnProperty('autologin')) {
        console.log('haha')
        console.log(console.info(this.$route.query.autologin))
        axios.post(util.auth, {
